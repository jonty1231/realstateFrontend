...
import Builderitem from "./slices/builderslice/Builderitemslice";
import builder from "./slices/builderslice/builderSlice";


export const store = configureStore({
      reducer: {propertySlice,trendingproperty,testimonial,blog,category,singleproperty,bannerimg,about,policy,Builderitem,builder},
    });
